...
class Options_gui:
    ...
    def __init__(self, main_gui, options_tab, widget_geometries, samples, texts, statuses):
        ...
        self.decrease_marker_size_button.bind_all('<Control-Down>', self.decrease_marker_size)
        ...
        self.increase_marker_size_button.bind_all('<Control-Up>', self.increase_marker_size)
