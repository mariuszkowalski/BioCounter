...
class Statistics_gui:
    ...
    def __init__(self, statistics_tab, widget_geometries, samples, statistics, texts):
        ...
        self.statistics_1_percent_label.place(x=self.widget_geometries.statistics_label_x,
                                              y=self.widget_geometries.statistics_percent_label_y)

        self.statistics_1_qualifier_1_percent= ttk.Entry(self.statistics_1_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_1_qualifier_1_percent)
        self.statistics_1_qualifier_1_percent.place(x=1 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_1_qualifier_2_percent = ttk.Entry(self.statistics_1_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_1_qualifier_2_percent)
        self.statistics_1_qualifier_2_percent.place(x=2 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_1_qualifier_3_percent = ttk.Entry(self.statistics_1_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_1_qualifier_3_percent)
        self.statistics_1_qualifier_3_percent.place(x=3 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_1_qualifier_4_percent = ttk.Entry(self.statistics_1_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_1_qualifier_4_percent)
        self.statistics_1_qualifier_4_percent.place(x=4 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)
        ...
        self.statistics_2_percent_label.place(x=self.widget_geometries.statistics_label_x,
                                              y=self.widget_geometries.statistics_percent_label_y)

        self.statistics_2_qualifier_1_percent= ttk.Entry(self.statistics_2_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_2_qualifier_1_percent)
        self.statistics_2_qualifier_1_percent.place(x=1 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_2_qualifier_2_percent = ttk.Entry(self.statistics_2_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_2_qualifier_2_percent)
        self.statistics_2_qualifier_2_percent.place(x=2 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_2_qualifier_3_percent = ttk.Entry(self.statistics_2_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_2_qualifier_3_percent)
        self.statistics_2_qualifier_3_percent.place(x=3 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_2_qualifier_4_percent = ttk.Entry(self.statistics_2_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_2_qualifier_4_percent)
        self.statistics_2_qualifier_4_percent.place(x=4 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)
        ...
        self.statistics_3_percent_label.place(x=self.widget_geometries.statistics_label_x,
                                              y=self.widget_geometries.statistics_percent_label_y)

        self.statistics_3_qualifier_1_percent= ttk.Entry(self.statistics_3_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_3_qualifier_1_percent)
        self.statistics_3_qualifier_1_percent.place(x=1 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_3_qualifier_2_percent = ttk.Entry(self.statistics_3_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_3_qualifier_2_percent)
        self.statistics_3_qualifier_2_percent.place(x=2 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_3_qualifier_3_percent = ttk.Entry(self.statistics_3_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_3_qualifier_3_percent)
        self.statistics_3_qualifier_3_percent.place(x=3 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_3_qualifier_4_percent = ttk.Entry(self.statistics_3_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_3_qualifier_4_percent)
        self.statistics_3_qualifier_4_percent.place(x=4 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)
        ...
        self.statistics_4_percent_label.place(x=self.widget_geometries.statistics_label_x,
                                              y=self.widget_geometries.statistics_percent_label_y)

        self.statistics_4_qualifier_1_percent= ttk.Entry(self.statistics_4_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_4_qualifier_1_percent)
        self.statistics_4_qualifier_1_percent.place(x=1 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_4_qualifier_2_percent = ttk.Entry(self.statistics_4_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_4_qualifier_2_percent)
        self.statistics_4_qualifier_2_percent.place(x=2 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_4_qualifier_3_percent = ttk.Entry(self.statistics_4_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_4_qualifier_3_percent)
        self.statistics_4_qualifier_3_percent.place(x=3 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_4_qualifier_4_percent = ttk.Entry(self.statistics_4_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_4_qualifier_4_percent)
        self.statistics_4_qualifier_4_percent.place(x=4 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)
        ...
        self.statistics_5_percent_label.place(x=self.widget_geometries.statistics_label_x,
                                              y=self.widget_geometries.statistics_percent_label_y)

        self.statistics_5_qualifier_1_percent= ttk.Entry(self.statistics_5_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_5_qualifier_1_percent)
        self.statistics_5_qualifier_1_percent.place(x=1 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_5_qualifier_2_percent = ttk.Entry(self.statistics_5_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_5_qualifier_2_percent)
        self.statistics_5_qualifier_2_percent.place(x=2 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_5_qualifier_3_percent = ttk.Entry(self.statistics_5_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_5_qualifier_3_percent)
        self.statistics_5_qualifier_3_percent.place(x=3 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_5_qualifier_4_percent = ttk.Entry(self.statistics_5_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_5_qualifier_4_percent)
        self.statistics_5_qualifier_4_percent.place(x=4 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)
        ...
        self.statistics_6_percent_label.place(x=self.widget_geometries.statistics_label_x,
                                              y=self.widget_geometries.statistics_percent_label_y)

        self.statistics_6_qualifier_1_percent= ttk.Entry(self.statistics_6_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_6_qualifier_1_percent)
        self.statistics_6_qualifier_1_percent.place(x=1 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_6_qualifier_2_percent = ttk.Entry(self.statistics_6_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_6_qualifier_2_percent)
        self.statistics_6_qualifier_2_percent.place(x=2 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_6_qualifier_3_percent = ttk.Entry(self.statistics_6_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_6_qualifier_3_percent)
        self.statistics_6_qualifier_3_percent.place(x=3 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_6_qualifier_4_percent = ttk.Entry(self.statistics_6_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_6_qualifier_4_percent)
        self.statistics_6_qualifier_4_percent.place(x=4 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)
        ...
        self.statistics_7_percent_label.place(x=self.widget_geometries.statistics_label_x,
                                              y=self.widget_geometries.statistics_percent_label_y)

        self.statistics_7_qualifier_1_percent= ttk.Entry(self.statistics_7_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_7_qualifier_1_percent)
        self.statistics_7_qualifier_1_percent.place(x=1 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_7_qualifier_2_percent = ttk.Entry(self.statistics_7_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_7_qualifier_2_percent)
        self.statistics_7_qualifier_2_percent.place(x=2 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_7_qualifier_3_percent = ttk.Entry(self.statistics_7_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_7_qualifier_3_percent)
        self.statistics_7_qualifier_3_percent.place(x=3 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_7_qualifier_4_percent = ttk.Entry(self.statistics_7_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_7_qualifier_4_percent)
        self.statistics_7_qualifier_4_percent.place(x=4 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)
        ...
        self.statistics_8_percent_label.place(x=self.widget_geometries.statistics_label_x,
                                              y=self.widget_geometries.statistics_percent_label_y)

        self.statistics_8_qualifier_1_percent= ttk.Entry(self.statistics_8_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_8_qualifier_1_percent)
        self.statistics_8_qualifier_1_percent.place(x=1 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_8_qualifier_2_percent = ttk.Entry(self.statistics_8_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_8_qualifier_2_percent)
        self.statistics_8_qualifier_2_percent.place(x=2 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_8_qualifier_3_percent = ttk.Entry(self.statistics_8_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_8_qualifier_3_percent)
        self.statistics_8_qualifier_3_percent.place(x=3 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)

        self.statistics_8_qualifier_4_percent = ttk.Entry(self.statistics_8_frame,
                                                  width=5,
                                                  justify=CENTER,
                                                  state='readonly',
                                                  textvariable=self.texts.quantity_sample_8_qualifier_4_percent)
        self.statistics_8_qualifier_4_percent.place(x=4 * self.widget_geometries.statistics_column_offset,
                                                    y=self.widget_geometries.statistics_percent_row_offset)
